...
const ClassCrud = ({singleData}) => {
    ...
    return (
        ...
        <div className="space-y-2 p-4">
            ...
            <p className="text-sm text-gray-700 uppercase font-semibold dark:text-gray-200">{teacherName}</p>
            <p className="text-sm text-gray-700 dark:text-gray-200">price: <span className='font-bold'>{price}</span></p>
