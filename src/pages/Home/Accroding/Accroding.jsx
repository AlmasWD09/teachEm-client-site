...
const Accroding = () => {
    return (
        <>
            <div className="bg-primaryGray py-20 mt-10">
                <Container>
                    <div className=" flex flex-col md:flex-row justify-center lg:items-center md:gap-5 lg:gap-20">
                        ...
                        <div className="md:w-[50%] lg:w-[60%]">
                            ...
                            <div className="">
                                {/* according component */}
                                <div className="collapse collapse-arrow bg-white p-4 mb-3 rounded">
                        ...
                        <div className="md:w-[50%] md:mt-28 lg:mt-0">
                            <img className="rounded-md lg:h-[600px] w-full object-cover" src={photo} alt="" />
                        </div>
                    </div>
                </Container>
            </div>
